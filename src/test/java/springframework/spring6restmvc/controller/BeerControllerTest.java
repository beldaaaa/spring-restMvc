...
class BeerControllerTest {
    ...
    void updateBlankBeerName() throws Exception {
        ...
        BeerDTO beerDTO = beerServiceImpl.beerList(null, null, null, null, null).getFirst();
        beerDTO.setBeerName("");
    ...
    void createNullBeerName() throws Exception {
        ...
        given(beerService.saveNewBeer(any(BeerDTO.class))).willReturn(beerServiceImpl.beerList(null, null, null, null, null).getFirst());
    ...
    void patchBeer() throws Exception {
        BeerDTO beer = beerServiceImpl.beerList(null, null, null, null, null).getFirst();//to give my request a body (JSON of the beer map object)
    ...
    void deleteBeer() throws Exception {//delete operation is probably the simplest REST operation
        BeerDTO beer = beerServiceImpl.beerList(null, null, null, null, null).getFirst();
...
//commented after ArgumentCaptor was defined above;
    ...
    void updateBeer() throws Exception {
        BeerDTO beer = beerServiceImpl.beerList(null, null, null, null, null).getFirst();//retrieves the first Beer object from the list of beers
    ...
    void getBeerList() throws Exception {
        given(beerService.beerList(null, null, null, null, null)).willReturn(beerServiceImpl.beerList(null, null, null, null, null));
    ...
    void getBearById() throws Exception {
        BeerDTO testBeer = beerServiceImpl.beerList(null, null, null, null, null).getFirst();
    ...
    void createNewBeer() throws Exception {
        ...
        given(beerService.saveNewBeer(any(BeerDTO.class))).willReturn(beerServiceImpl.beerList(null, null, null, null, null).get(1));
